...
function QuizCancer() {
    ...
    const shouldSkipNextQuestion = (currentQuestion, answer) => {
        if (currentQuestion === 1 && answer === 'B) Não') {
            return true;
        }
        return false;
    };
        ...
        <div className="background">
            <div className="opcoesBox">
                <h1 className="infoPerguntas">
                    ...
                    {!quizStarted ? (
                        <button className="botao botao__iniciar" onClick={handleStartQuiz}>
                            Iniciar o quiz
                        </button>
                    ) : showResult ? (
                        <div className="pointsShow">
                            ...
                            <button className="botao botao__reiniciar" onClick={restartQuiz}>
                                Reiniciar o quiz
                            </button>
                        </div>
                    ) : (
